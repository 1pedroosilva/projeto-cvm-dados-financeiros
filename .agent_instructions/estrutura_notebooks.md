...
* **Histórico git como narrativa**: Em pipelines versionados onde commits incrementais contam a história técnica, `.py` trabalha a favor
...
* **Não aparecem no Git** - só o código commitado é versionado
* Em pipelines versionados, o que importa é o histórico git (commits, PRs, evolução do código)
