...
# Critério: COUNT(*) > 0 na tabela Bronze DRE
# ============================================================================
...
# Critério: COUNT(*) > 0 na tabela Silver DRE
# ============================================================================
...
# Nota: ORDEM_EXERC é parte da PK porque a DRE traz exercício corrente (ÚLTIMO)
#       e anterior (PENÚLTIMO) para a mesma conta e data de referência.
#       A Window Function do 201 particiona por essas 4 colunas.
# ============================================================================
